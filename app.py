...
input_data = pd.DataFrame({
    ...
    'Geography': [geography]  # <- This line is essential for encoding
})
...
# Drop 'Geography' from original input and merge encoded
input_data = input_data.drop(columns=['Geography']).reset_index(drop=True)
